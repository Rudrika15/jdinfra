    ...
    <div class="container-fluid border border p-0 m-0">
        <div class="row m-0 p-3" style="background-color: #0b6ab2">
            ...
            <div class="col-lg-2 d-flex justify-content-end align-items-center">
                <span style="float:right; margin-right: 1%"><a href="{{ route('sector.index', $sector->projectid) }}"
                        class="btn" style="background-color: #e3f2fd">Back</a></span>
            </div>
        </div>
        <div class="container-fluid  mt-3">
            <form action="{{ route('sectorplot.store', $sector->projectid) }}" method="post" class="p-5">
                @csrf
