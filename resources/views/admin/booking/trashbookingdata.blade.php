...
@section('content')
    <div class="container-fluid  p-0 m-0">
        ...
        <div class="row mb-2 p-3" style="background-color: #0b6ab2">
            <div class="col-lg-11">
                <h2 class="text-center text-white">TRASHED BOOKINGS OF {{ $project->title }}   </h2>
            </div>
            <div class="col-lg-1 d-flex justify-content-end align-items-center">
                <span>
                    <a href="{{ route('admin.booking.viewbooking', request()->route('projectid')) }}" class="btn"
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('trashview', '') }}/" + projectId,
                columns: [{
                        data: null,
                        name: 'iteration',
                        orderable: false,
