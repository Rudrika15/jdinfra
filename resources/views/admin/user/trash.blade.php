...
@section('content')
    ...
    <div class="container-fluid p-0 m-0">
        <div class="row m-0 p-3" style="background-color: #0b6ab2">
            <div class="col-lg-6">
                <h2 class="text-white">@if (count($users) > 0)
                    TRASH DATA 
                @else
                        ...
                        @if (Auth::user()->usertype == 'admin')
                            <td>
                                <div class="d-flex gap-2">
                                    <div>
                                        <a onclick="return confirm('do you want to restore it')" href="{{ route('users.restore', $item->id) }}"
            ...
            button.addEventListener('click', (e) => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = `/users/force-delete/${userId}`;
                    }
                });
            });
        });
