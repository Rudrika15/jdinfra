...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('admin.user.updateclient', $clients->id) }}" method="post">
            @csrf
            @method('put')
            <div class="row">
                <div class="col mb-3">
                    <label for="name" class="form-label">Client Name</label>
                    <input type="text" value="{{ $clients->name }}" name="name" class="form-control" id="title">
                ...
                <div class="col mb-3">
                    ...
                    <input type="text" value="{{ $clients->email }}" name="email" class="form-control" id="title">
                    <span class="text-danger">
                        @error('email')
                            {{ $message }}
                        @enderror
            ...
            <div class="row">
                <div class="col mb-3">
                    ...
                    <input type="text" value="{{ $clients->mobile }}" name="mobile" class="form-control" id="title">
                    <span class="text-danger">
                        @error('mobile')
                            {{ $message }}
                        @enderror
                ...
                <div class="col mb-3">
                    ...
                    <input type="text" value="{{ $clients->alternatemobile }}" name="alternatemobile"
                        class="form-control">
                    <span class="text-danger">
            ...
            <div class="row">
                <div class="col mb-3">
                    ...
                    <select name="doctype" class="form-control" id="id_card_type">
                        ...
                        <option value="Adhaar Card"{{ $clients->doctype == 'Adhaar Card' ? 'selected' : '' }}>Adhaar Card
                        </option>
                        <option value="Pan Card"{{ $clients->doctype == 'Pan Card' ? 'selected' : '' }}>Pan Card</option>
                        <option value="Driving License"{{ $clients->doctype == 'Driving License' ? 'selected' : '' }}>
                            Driving License</option>
                        <option value="Voter Id"{{ $clients->doctype == 'Voter ID' ? 'selected' : '' }}>Voter Id</option>
                    </select>
                    <span class="text-danger">
                        @error('doctype')
                            {{ $message }}
                ...
                <div class="col mb-3">
                    ...
                    <input type="text" id="id_card_number" value="{{ $clients->docnumber }}" name="docnumber"
                        class="form-control">
                    <span class="text-danger">
                        @error('docnumber')
                            {{ $message }}
            ...
            <div class="row">
                <div class="col mb-3">
                    ...
                    <textarea name="address" class="form-control" cols="30" rows="1">{{ $clients->address }}</textarea>
                    <span class="text-danger">
                        @error('address')
                            {{ $message }}
                        @enderror
                ...
                <div class="col mb-3">
                    ...
                    <input type="text" value="{{ $clients->city }}" name="city" class="form-control" id="title">
                    <span class="text-danger">
                        @error('city')
                            {{ $message }}
                        @enderror
